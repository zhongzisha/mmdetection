...
@weighted_loss
def rotated_iou_loss_360(pred, target, angle_loss_type='mse', angle_loss_weight=1.0, eps=1e-6):
    """IoU loss.
...
class RotatedIoULoss_360(nn.Module):

    def __init__(self, eps=1e-6, reduction='mean', loss_weight=1.0,
                 angle_loss_type='mse',
                 angle_loss_weight=1.0):
        super(RotatedIoULoss_360, self).__init__()
        self.eps = eps
    ...
    def forward(self,
        ...
        loss = self.loss_weight * rotated_iou_loss_360(
            pred,
            target,
            weight,
