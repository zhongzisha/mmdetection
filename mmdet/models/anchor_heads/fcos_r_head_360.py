...
class FCOSRHead_360(nn.Module):
    ...
    def __init__(self,
        ...
        super(FCOSRHead_360, self).__init__()
    ...
    def _init_layers(self):
        ...
        self.fcos_reg = nn.Conv2d(self.feat_channels, 5, 3, padding=1)   # +theta
    ...
    def fcos_target_single(self, gt_bboxes, gt_quads, gt_labels, img_meta, points, regress_ranges,
        ...
        angles = gt_obbs[:, 4] / (2*np.pi) # [0, 2pi]
