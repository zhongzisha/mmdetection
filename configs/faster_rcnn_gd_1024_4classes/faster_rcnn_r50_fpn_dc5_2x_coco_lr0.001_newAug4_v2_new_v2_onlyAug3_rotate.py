...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1536, 800), keep_ratio=True),
...
train_data3 = dict(
        classes=classes,
        type='Gd1024Dataset',
        ann_file='data/gd_newAug5_Rot1_4classes/box_aug_v3/train1/train1.json',
        img_prefix='data/gd_newAug5_Rot1_4classes/box_aug_v3/train1/images/',
        pipeline=train_pipeline)
val_data3 = dict(
        classes=classes,
        type='Gd1024Dataset',
        ann_file='data/gd_newAug5_Rot1_4classes/box_aug_v3/val1/val1.json',
        img_prefix='data/gd_newAug5_Rot1_4classes/box_aug_v3/val1/images/',
        pipeline=test_pipeline)
test_data3 = dict(
        classes=classes,
        type='Gd1024Dataset',
