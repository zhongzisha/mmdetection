...
train_data2 = dict(
        classes=classes,
        type='Gd1024Dataset',
        ann_file='data/gd_newAug5_Rot1_4classes/box_aug_v2/train1/train1.json',
        img_prefix='data/gd_newAug5_Rot1_4classes/box_aug_v2/train1/images/',
        pipeline=train_pipeline)
val_data2 = dict(
        classes=classes,
        type='Gd1024Dataset',
        ann_file='data/gd_newAug5_Rot1_4classes/box_aug_v2/val1/val1.json',
        img_prefix='data/gd_newAug5_Rot1_4classes/box_aug_v2/val1/images/',
        pipeline=test_pipeline)
test_data2 = dict(
        classes=classes,
        type='Gd1024Dataset',
